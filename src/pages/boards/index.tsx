...
const Boards = () => {
  ...
  return (
    <div className="mt-8 px-4 md:mt-10 lg:mt-10 lg:px-[360px]">
      <h2 className="text-2xl font-bold text-text-primary mb-6">자유게시판</h2>
      <SearchInput />
      <div className="flex justify-between items-center my-6">
        <h3 className="text-lg font-medium text-text-primary">베스트 게시글</h3>
      ...
      <div className="flex justify-between items-center mb-6">
        <h3 className="text-lg font-medium text-text-primary">게시글</h3>
        <div>
          <Dropdown
      ...
      <div className="fixed bottom-[230px] right-4 md:bottom-[125px] lg:bottom-[45px] lg:right-[360px]">
        <FloatingButton option="add" text="글쓰기" />
      </div>
    </div>
  );
};
